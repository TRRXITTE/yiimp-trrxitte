...
func (p *PoolServer) submitAuxBlockForChain(primaryBlock bitcoin.BitcoinBlock, auxBlock bitcoin.AuxBlock, chainName string) error {
	auxpow := bitcoin.MakeAuxPowWithBranch(primaryBlock, auxBlock)
